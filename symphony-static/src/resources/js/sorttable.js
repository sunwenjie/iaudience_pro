    ...
    insertCheckbox:function(){
      ...
      $("#"+self.id).find('tr').each(function(){
        ...
        if(typeof(audience_and_bshare_id) != "undefined"){
          ...
          total += 1;
          var insert_checkbox = "<td class='align_center' style='width:23px;'><input class='audience_chbx internal_interest_check' id='e' name='audience_id[]' type='checkbox'"+input_checked+" value= "+audience_id+ " bshare_audience_id=" + bshare_audience_id + " audience_num_show=" + audience_num_show +" /></td>";
